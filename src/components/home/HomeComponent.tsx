...
export default function HomeComponent() {
    return (
        <div className="flex flex-col gap-18 max-w-[1350px] sm:mx-5 h-full mx-auto mb-28 relative ">
            {/* First Section */}
            <section className="flex max-w-[1184px] w-full mx-auto justify-between md:flex-col md:max-w-[95%] items-center gap-12 sm:flex-col-reverse sm:items-center sm:w-full my-12">
                <article className="flex flex-col gap-[57px] items-start max-w-[474px] md:w-full md:items-center sm:w-full sm:items-start sm:gap-6">
                    <div className="flex flex-col gap-9 sm:gap-4">
                        <h2 className="text-[64px] leading-[76px] font-medium text-black-light text-nowrap xl:text-header2 md:text-center sm:text-start sm:text-[48px]">
                            Xoş Gəldiniz!
                        </h2>
                        <p className="text-[32px] leading-[38px] text-gray-30 sm:text-lg-2 sm:text-balance">
                    ...
                    <a href="#begin-exam">
                        <CustomButton className="px-10 py-4 rounded-[20px] bg-button-gradient  sm:text-md">Sınaq İmtahanı</CustomButton>
                    </a>
                </article>
            ...
            <div className="flex flex-col items-center gap-[120px] md:items-center md:gap-20 sm:gap-14" id="begin-exam">
                <article>
                    <h3 className="text-[45px] leading-[60px] text-center sm:text-[32px] sm:leading-10">
                ...
                {/* Third Section */}
                <section className="flex max-w-[812px] justify-between sm:flex-col sm:gap-14 sm:mx-5">
                    <article className="flex flex-col gap-8 w-[42%] items-center text-center xl:w-[35%] md:w-[50%] sm:w-full sm:shadow-exam-info sm:rounded-xs sm:px-11 sm:pt-3 pb-12">
                    ...
                    <article className="flex flex-col items-center w-[42%] gap-8 text-center xl:w-[35%] md:w-[50%] sm:w-full sm:shadow-exam-info sm:rounded-xs sm:px-11 sm:pt-3 pb-12">
                        <div className="py-3 pl-8 pr-5  rounded-[50%] bg-[#FFECE0] shadow-dot-shadow ">
            ...
            <a href="#top" className="absolute right-5 bottom-16 p-5 rounded-md border-[3px]  border-orange-60 w-[75px] sm:hidden ">
                <ArrowToTop />
                <ArrowToTop />
            </a>
        </div>
